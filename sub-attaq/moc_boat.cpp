...
struct qt_meta_stringdata_Boat_t {
    QByteArrayData data[4];
    char stringdata0[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Boat_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Boat_t qt_meta_stringdata_Boat = {
    {
QT_MOC_LITERAL(0, 0, 4), // "Boat"
QT_MOC_LITERAL(1, 5, 13), // "boatDestroyed"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 21) // "boatExecutionFinished"

    },
    "Boat\0boatDestroyed\0\0boatExecutionFinished"
};
...
void Boat::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Boat::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Boat::boatDestroyed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Boat::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Boat::boatExecutionFinished)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Boat::staticMetaObject = {
    { &PixmapItem::staticMetaObject, qt_meta_stringdata_Boat.data,
      qt_meta_data_Boat,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Boat::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Boat.stringdata0))
