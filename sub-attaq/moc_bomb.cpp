...
QT_MOC_LITERAL(1, 5, 12), // "bombExploded"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 21), // "bombExecutionFinished"
QT_MOC_LITERAL(4, 41, 29) // "onAnimationLaunchValueChanged"

    },
    "Bomb\0bombExploded\0\0bombExecutionFinished\0"
...
void Bomb::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Bomb::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Bomb::bombExploded)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Bomb::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Bomb::bombExecutionFinished)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Bomb::staticMetaObject = {
    { &PixmapItem::staticMetaObject, qt_meta_stringdata_Bomb.data,
      qt_meta_data_Bomb,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
