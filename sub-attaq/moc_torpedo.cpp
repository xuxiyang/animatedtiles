...
struct qt_meta_stringdata_Torpedo_t {
    QByteArrayData data[5];
    char stringdata0[80];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Torpedo_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Torpedo_t qt_meta_stringdata_Torpedo = {
    {
QT_MOC_LITERAL(0, 0, 7), // "Torpedo"
QT_MOC_LITERAL(1, 8, 15), // "torpedoExploded"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 24), // "torpedoExecutionFinished"
QT_MOC_LITERAL(4, 50, 29) // "onAnimationLaunchValueChanged"

    },
    "Torpedo\0torpedoExploded\0\0"
    "torpedoExecutionFinished\0"
    "onAnimationLaunchValueChanged"
};
...
void Torpedo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Torpedo::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Torpedo::torpedoExploded)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Torpedo::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Torpedo::torpedoExecutionFinished)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Torpedo::staticMetaObject = {
    { &PixmapItem::staticMetaObject, qt_meta_stringdata_Torpedo.data,
      qt_meta_data_Torpedo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Torpedo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Torpedo.stringdata0))
