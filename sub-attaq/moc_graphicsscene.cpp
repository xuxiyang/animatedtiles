...
void GraphicsScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsScene::subMarineDestroyed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (GraphicsScene::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsScene::allSubMarineDestroyed)) {
                *result = 1;
                return;
            }
        }
